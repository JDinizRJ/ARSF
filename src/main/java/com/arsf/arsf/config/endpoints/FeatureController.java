...
public class FeatureController {
    ...
    @GetMapping("/featurenotin")
    @ResponseBody
        public List<Feature> returnByAppIdAndFeatureNotInList(
            @RequestParam("idApp") String idApp,
            @RequestParam("idFeature") List<String> featureList) {
        return featureService.returnByAppIdAndFeatureNotInList(idApp, featureList);
    }
