...
public class PermissionRolesPK implements Serializable {
    private String idFeature;
    private String idPermission;
    private String idRole;

    public PermissionRolesPK() {
        // Construtor padrão vazio necessário para o Hibernate
    }

    public PermissionRolesPK(String idFeature, String idPermission, String idRole) {
