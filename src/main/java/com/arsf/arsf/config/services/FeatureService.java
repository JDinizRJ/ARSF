...
public class FeatureService {
    ...
    public List<Feature> returnByAppIdAndFeatureNotInList(String idApp, List<String> featureList) {
        return featureRepository.returnByAppIdAndFeatureNotInList(idApp, featureList);
    }
